...
module.exports = class PrefixCommand extends Command {
    ...
    if(lowercase === 'default'){
      msg.guild.member(this.client.user.id).setNickname(`ParaCommando`)
    } else if (lowercase === 'none') msg.guild.member(this.client.user.id).setNickname(`ParaCommando`);
    else if (lowercase) msg.guild.member(this.client.user.id).setNickname(`[${lowercase}] ParaCommando`);
